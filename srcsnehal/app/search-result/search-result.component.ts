...
// import { ConvertdataobPipe } from './convertdataob.module';
...
export class SearchResultComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.sub = this.route.queryParams.subscribe(params => {
          ...
          else if(object[0] == 'property'){
            this.searchByPropType();
          }  
          else if(object[0] == 'frontdata'){
            this.getUrllocData();
          }  
          else if(object[0] == 'alldata'){
            this.getalldata();
          }  
  ...
  getprice(){
    this.dataservice.listallrpriceService().subscribe(res=>{
      this.price=res;
      // alert("hiiiiiiiiiiiiiiiiiiii"+JSON.stringify(this.price1));
      // // this.price=(this.price1)/100000;
      
      // // for(let i=0 ;i<this.price1[i].length;i++){
      // //    this.numprice[i]=(this.price[i].price).includes('L')?(parseFloat(this.price[i].price)):(parseFloat(this.price[i].price)*100);
      // //   this.price[i]=(this.price1[i].price_converted);
        
      // // }
      // for(let i=0 ;i<this.price1[i].length;i++){
      //   this.price=this.price1[i].price_converted/100000;
      // }
